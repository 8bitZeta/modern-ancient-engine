...
.equal_priority
	...
	ld a, d
	cp HELD_QUICK_CLAW
	jp nz, .player_no_quick_claw
	ld a, b
	cp HELD_QUICK_CLAW
	jp z, .both_have_quick_claw
	call BattleRandom
	cp e
	jp nc, .speed_check
	jp .player_first
...
.trainer
	...
	ld a, [hli]
	or [hl]
	jp nz, .player_mon_did_not_faint
...
.skip_link
	...
	ld [wBattlePlayerAction], a
	call CheckMobileBattleError
	jp c, .enemy_fainted_mobile_error
	ld hl, wEnemyMonHP
	ld a, [hli]
	or [hl]
	jp nz, .send_out_pokemon
...
CheckMobileBattleError:
	ld a, [wLinkMode]
	cp LINK_MOBILE
	jp nz, .not_mobile ; It's not a mobile battle
...
.not_linked
	ld a, [wEnemySwitchMonIndex]
	and a
	jp z, .check_wBattleHasJustStarted
...
PrintPlayerHUD:
	...
	callfar GetGender
	ld a, " "
	jp c, .got_gender_char
	ld a, "♂"
	jp nz, .got_gender_char
	ld a, "♀"
...
.got_gender_char
	...
	ld a, b
	cp " "
	jp nz, .copy_level ; male or female
	dec hl ; genderless
...
.menu_loop
	ld a, [wMoveSelectionMenuType]
	and a
	jp z, .battle_player_moves
	dec a
	jp nz, .interpret_joypad
	hlcoord 11, 14
	ld de, .empty_string
	call PlaceString
	jp .interpret_joypad
...
.interpret_joypad
	...
	ld a, [wMoveSelectionMenuType]
	dec a
	jp nz, .not_enemy_moves_process_b
...
.pressed_select
	...
	ld a, [wMenuCursorY]
	cp b
	jp nz, .not_swapping_disabled_move
	ld a, [hl]
	and $f
	ld b, a
	ld a, [wSwappingMove]
	...
	add b
	ld [hl], a
	jp .swap_moves_in_party_struct

.not_swapping_disabled_move
	ld a, [wSwappingMove]
	cp b
	jp nz, .swap_moves_in_party_struct
	ld a, [hl]
	and $f
	ld b, a
	ld a, [wMenuCursorY]
...
; Input DVs in register bc
	...
	ld [hli], a
	ld [hl], c
; Now we need to generate the PV!
	farcall GeneratePV
; END EDITS
...
; If combined with forced shiny battletype, causes an infinite loop
	...
	jp .Happiness ; skip the Magikarp check
...
; No reason to keep going if length > 1536 mm (i.e. if HIGH(length) > 6 feet)
	...
	cp HIGH(1536)
	jp nz, .CheckMagikarpArea

; 5% chance of skipping both size checks
	call Random
	cp 5 percent
	jp c, .CheckMagikarpArea
...
.decrease_evs_gained
	...
	jp nc, .check_ev_overflow
	dec e
	dec bc
	jp .decrease_evs_gained
.check_ev_overflow
	pop hl 
	pop bc 
	ld a, e
...
; Boost experience for Lucky Egg
	...
	adc d
	ld [hl], a
	jp nc, .no_exp_overflow
	dec hl
	inc [hl]
	jp nz, .no_exp_overflow
	ld a, $ff
	ld [hli], a
	ld [hli], a
	ld [hl], a
...
GoMonText:
	text_far _GoMonText
	text_asm
	jp PrepareBattleMonNicknameText
...
GetBattleMonBackpic:
	...
	jp nz, GetBattleMonBackpic_DoAnim ; substitute

DropPlayerSub:
	ld a, [wPlayerMinimized]
	and a
	ld hl, BattleAnimCmd_MinimizeOpp
	jp nz, GetBattleMonBackpic_DoAnim
	ld a, [wCurPartySpecies]
	push af
	ld a, [wBattleMonSpecies]
	ld [wCurPartySpecies], a
...
GetEnemyMonFrontpic:
	...
	bit SUBSTATUS_SUBSTITUTE, a
	ld hl, BattleAnimCmd_RaiseSub
	jp nz, GetEnemyMonFrontpic_DoAnim
...
BattleEnd_HandleRoamMons:
	...
	ld a, [wBattleResult]
	and $f
	jp z, .caught_or_defeated_roam_mon ; WIN
	call GetRoamMonHP
	ld a, [wEnemyMonHP + 1]
	ld [hl], a
	jp .update_roam_mons
...
.not_shiny
	...
	predef AnimateFrontpic
	jp .skip_cry ; cry is played during the animation
