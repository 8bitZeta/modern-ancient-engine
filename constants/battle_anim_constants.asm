...
; the first 6 matches PAL_BATTLE_OB_GRAY/YELLOW/...
	...
	const PAL_BTLCUSTOM_MASTER_BALL          ; 32
	const PAL_BTLCUSTOM_MASTER_BALL_CAUGHT   ; 33
	const PAL_BTLCUSTOM_ULTRA_BALL           ; 34
	const PAL_BTLCUSTOM_ULTRA_BALL_CAUGHT    ; 35
	const PAL_BTLCUSTOM_GREAT_BALL           ; 36
	const PAL_BTLCUSTOM_GREAT_BALL_CAUGHT    ; 37
	const PAL_BTLCUSTOM_POKE_BALL            ; 38
	const PAL_BTLCUSTOM_POKE_BALL_CAUGHT     ; 39
	const PAL_BTLCUSTOM_SAFARI_BALL          ; 3a
	const PAL_BTLCUSTOM_SAFARI_BALL_CAUGHT   ; 3b
	const PAL_BTLCUSTOM_NET_BALL             ; 3c
	const PAL_BTLCUSTOM_NET_BALL_CAUGHT      ; 3d
	const PAL_BTLCUSTOM_DIVE_BALL            ; 3e
	const PAL_BTLCUSTOM_DIVE_BALL_CAUGHT     ; 3f
	const PAL_BTLCUSTOM_NEST_BALL            ; 40
	const PAL_BTLCUSTOM_NEST_BALL_CAUGHT     ; 41
	const PAL_BTLCUSTOM_REPEAT_BALL          ; 42
	const PAL_BTLCUSTOM_REPEAT_BALL_CAUGHT   ; 43
	const PAL_BTLCUSTOM_TIMER_BALL           ; 44
	const PAL_BTLCUSTOM_TIMER_BALL_CAUGHT    ; 45
	const PAL_BTLCUSTOM_LUXURY_BALL          ; 46
	const PAL_BTLCUSTOM_LUXURY_BALL_CAUGHT   ; 47
	const PAL_BTLCUSTOM_PREMIER_BALL         ; 48
	const PAL_BTLCUSTOM_PREMIER_BALL_CAUGHT  ; 49
	const PAL_BTLCUSTOM_DUSK_BALL            ; 4a
	const PAL_BTLCUSTOM_DUSK_BALL_CAUGHT     ; 4b
	const PAL_BTLCUSTOM_HEAL_BALL            ; 4c
	const PAL_BTLCUSTOM_HEAL_BALL_CAUGHT     ; 4d
	const PAL_BTLCUSTOM_QUICK_BALL           ; 4e
	const PAL_BTLCUSTOM_QUICK_BALL_CAUGHT    ; 4f
	const PAL_BTLCUSTOM_CHERISH_BALL         ; 50
	const PAL_BTLCUSTOM_CHERISH_BALL_CAUGHT  ; 51
	const PAL_BTLCUSTOM_FAST_BALL            ; 52
	const PAL_BTLCUSTOM_FAST_BALL_CAUGHT     ; 53
	const PAL_BTLCUSTOM_LEVEL_BALL           ; 54
	const PAL_BTLCUSTOM_LEVEL_BALL_CAUGHT    ; 55
	const PAL_BTLCUSTOM_LURE_BALL            ; 56
	const PAL_BTLCUSTOM_LURE_BALL_CAUGHT     ; 57
	const PAL_BTLCUSTOM_HEAVY_BALL           ; 58
	const PAL_BTLCUSTOM_HEAVY_BALL_CAUGHT    ; 59
	const PAL_BTLCUSTOM_LOVE_BALL            ; 5a
	const PAL_BTLCUSTOM_LOVE_BALL_CAUGHT     ; 5b
	const PAL_BTLCUSTOM_FRIEND_BALL          ; 5c
	const PAL_BTLCUSTOM_FRIEND_BALL_CAUGHT   ; 5d
	const PAL_BTLCUSTOM_MOON_BALL            ; 5e
	const PAL_BTLCUSTOM_MOON_BALL_CAUGHT     ; 5f
	const PAL_BTLCUSTOM_PARK_BALL            ; 60
	const PAL_BTLCUSTOM_PARK_BALL_CAUGHT     ; 61
