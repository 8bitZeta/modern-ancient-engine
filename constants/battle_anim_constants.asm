...
; the first 6 matches PAL_BATTLE_OB_GRAY/YELLOW/...
	...
	const PAL_BTLCUSTOM_POKE_BALL          ; 30
	const PAL_BTLCUSTOM_POKE_BALL_CAUGHT   ; 31
	const PAL_BTLCUSTOM_GREAT_BALL         ; 32
	const PAL_BTLCUSTOM_GREAT_BALL_CAUGHT  ; 33
	const PAL_BTLCUSTOM_ULTRA_BALL         ; 34
	const PAL_BTLCUSTOM_ULTRA_BALL_CAUGHT  ; 35
	const PAL_BTLCUSTOM_MASTER_BALL        ; 36
	const PAL_BTLCUSTOM_MASTER_BALL_CAUGHT ; 37
	const PAL_BTLCUSTOM_LEVEL_BALL         ; 38
	const PAL_BTLCUSTOM_LEVEL_BALL_CAUGHT  ; 39
	const PAL_BTLCUSTOM_LURE_BALL          ; 3a
	const PAL_BTLCUSTOM_LURE_BALL_CAUGHT   ; 3b
	const PAL_BTLCUSTOM_MOON_BALL          ; 3c
	const PAL_BTLCUSTOM_MOON_BALL_CAUGHT   ; 3d
	const PAL_BTLCUSTOM_FRIEND_BALL        ; 3e
	const PAL_BTLCUSTOM_FRIEND_BALL_CAUGHT ; 3f
	const PAL_BTLCUSTOM_FAST_BALL          ; 40
	const PAL_BTLCUSTOM_FAST_BALL_CAUGHT   ; 41
	const PAL_BTLCUSTOM_HEAVY_BALL         ; 42
	const PAL_BTLCUSTOM_HEAVY_BALL_CAUGHT  ; 43
	const PAL_BTLCUSTOM_LOVE_BALL          ; 44
	const PAL_BTLCUSTOM_LOVE_BALL_CAUGHT   ; 45
