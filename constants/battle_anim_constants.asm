...
; BattleAnimObjects indexes (see data/battle_anims/objects.asm)
	...
	const ANIM_OBJ_HEART_CAPTIVATE
	...
	const ANIM_OBJ_WIND_SPARKLE_SHORT
	...
	const ANIM_OBJ_EXPLOSION_SMALL_YFIX
	const ANIM_OBJ_ROOST
	const ANIM_OBJ_MIRACLE_EYE
	const ANIM_OBJ_WAKE_UP_SLAP_L
	const ANIM_OBJ_WAKE_UP_SLAP_R
	...
	const ANIM_OBJ_HEAL_BLOCK
	const ANIM_OBJ_HEAL_BLOCK_SLOW
	const ANIM_OBJ_HEAL_BLOCK_SLOWER
	...
	const ANIM_OBJ_TINY_GLOW_CLEAR
	const ANIM_OBJ_ORBITING_ORBS
	const ANIM_OBJ_MAGNET_RISE
	const ANIM_OBJ_PALM_STILL
	const ANIM_OBJ_FORCE_PALM
	...
	const ANIM_OBJ_PSYCHO_CUT_CRESCENT
	...
	const ANIM_OBJ_DISCHARGE_SPARKS_N
	const ANIM_OBJ_DISCHARGE_SPARKS_NE
	const ANIM_OBJ_DISCHARGE_SPARKS_E
	const ANIM_OBJ_DISCHARGE_SPARKS_SE
	const ANIM_OBJ_DISCHARGE_SPARKS_S
	const ANIM_OBJ_DISCHARGE_SPARKS_SW
	...
	const ANIM_OBJ_LEAF_STORM_LEAF
	...
	const ANIM_OBJ_CHATTER_NOTE
	const ANIM_OBJ_JUDGMENT_N
	const ANIM_OBJ_JUDGMENT_NE
	const ANIM_OBJ_JUDGMENT_E
	const ANIM_OBJ_JUDGMENT_SE
	const ANIM_OBJ_JUDGMENT_S
	const ANIM_OBJ_JUDGMENT_SW
	const ANIM_OBJ_JUDGMENT_W
	const ANIM_OBJ_JUDGMENT_NW
	const ANIM_OBJ_JUDGMENT_STREAK_45DEG_R
	const ANIM_OBJ_JUDGMENT_STREAK_45DEG_L
	const ANIM_OBJ_JUDGMENT_STREAK_85DEG_L
	const ANIM_OBJ_JUDGMENT_STREAK_5DEG_R_Y_FLIP
	const ANIM_OBJ_JUDGMENT_STREAK_45DEG_R_Y_FLIP
	const ANIM_OBJ_JUDGMENT_STREAK_85DEG_R_Y_FLIP
	...
	const ANIM_OBJ_BEE_POOF
	const ANIM_OBJ_ENERGY_ORB_TINY
	const ANIM_OBJ_ROT_N
	const ANIM_OBJ_ROT_NE
	const ANIM_OBJ_ROT_E
	const ANIM_OBJ_ROT_SE
	const ANIM_OBJ_ROT_S
	const ANIM_OBJ_ROT_SW
	...
	const ANIM_OBJ_MAGMA_STORM
	const ANIM_OBJ_FIRE_BG
	const ANIM_OBJ_DARK_VOID_BG
	const ANIM_OBJ_ENERGY_ORB_TINY_OUT
	const ANIM_OBJ_SEED_FLARE_N
	const ANIM_OBJ_SEED_FLARE_NE
	const ANIM_OBJ_SEED_FLARE_E
	const ANIM_OBJ_SEED_FLARE_SE
	const ANIM_OBJ_SEED_FLARE_S
	const ANIM_OBJ_SEED_FLARE_SW
	const ANIM_OBJ_SEED_FLARE_W
	const ANIM_OBJ_SEED_FLARE_NW
	const ANIM_OBJ_SEED_OUT
	const ANIM_OBJ_SMALL_GLOW_OUT
...
; BattleAnimFrameData indexes (see data/battle_anims/framesets.asm)
	...
	const BATTLEANIMFRAMESET_BLUR_DIAGONAL
	...
	const BATTLEANIMFRAMESET_WAKE_UP_SLAP_L
	const BATTLEANIMFRAMESET_WAKE_UP_SLAP_R
	...
	const BATTLEANIMFRAMESET_HEAL_BLOCK_SLOW
	...
	const BATTLEANIMFRAMESET_DEPRESSION
	const BATTLEANIMFRAMESET_SUCKER_PUNCH_L
	const BATTLEANIMFRAMESET_SUCKER_PUNCH_R
	const BATTLEANIMFRAMESET_AQUA_RING
	const BATTLEANIMFRAMESET_MAGNET_RISE
	const BATTLEANIMFRAMESET_PALM_STILL
	const BATTLEANIMFRAMESET_SWIRL_SHORT
	const BATTLEANIMFRAMESET_ROCK_POLISH_5DEG_R
	const BATTLEANIMFRAMESET_ROCK_POLISH_45DEG_R
	const BATTLEANIMFRAMESET_ROCK_POLISH_85DEG_R
	const BATTLEANIMFRAMESET_ROCK_POLISH_5DEG_L
	const BATTLEANIMFRAMESET_ROCK_POLISH_45DEG_L
	const BATTLEANIMFRAMESET_ROCK_POLISH_85DEG_L
	const BATTLEANIMFRAMESET_ROCK_POLISH_5DEG_R_Y_FLIP
	const BATTLEANIMFRAMESET_ROCK_POLISH_45DEG_R_Y_FLIP
	const BATTLEANIMFRAMESET_ROCK_POLISH_85DEG_R_Y_FLIP
	const BATTLEANIMFRAMESET_ROCK_POLISH_5DEG_L_Y_FLIP
	const BATTLEANIMFRAMESET_ROCK_POLISH_45DEG_L_Y_FLIP
	...
	const BATTLEANIMFRAMESET_DISCHARGE_SPARKS_NE
	const BATTLEANIMFRAMESET_DISCHARGE_SPARKS_E
	const BATTLEANIMFRAMESET_DISCHARGE_SPARKS_SE
	const BATTLEANIMFRAMESET_DISCHARGE_SPARKS_S
	const BATTLEANIMFRAMESET_DISCHARGE_SPARKS_SW
	...
	const BATTLEANIMFRAMESET_LEAF_STORM_LEAF
	...
	const BATTLEANIMFRAMESET_ENERGY_ORB_TINY
	const BATTLEANIMFRAMESET_ROT_N
	const BATTLEANIMFRAMESET_ROT_NE
	const BATTLEANIMFRAMESET_ROT_E
	const BATTLEANIMFRAMESET_ROT_SE
	const BATTLEANIMFRAMESET_ROT_S
	const BATTLEANIMFRAMESET_ROT_SW
	...
	const BATTLEANIMFRAMESET_MAGMA_STORM
	const BATTLEANIMFRAMESET_BIG_WHIP_N
	const BATTLEANIMFRAMESET_BIG_WHIP_NE
	const BATTLEANIMFRAMESET_BIG_WHIP_E
	const BATTLEANIMFRAMESET_BIG_WHIP_SE
	const BATTLEANIMFRAMESET_BIG_WHIP_S
	const BATTLEANIMFRAMESET_BIG_WHIP_SW
	const BATTLEANIMFRAMESET_BIG_WHIP_W
	const BATTLEANIMFRAMESET_BIG_WHIP_NW
	const BATTLEANIMFRAMESET_SEED_OUT
	const BATTLEANIMFRAMESET_SMALL_GLOW_SHORT
...
; the first 6 matches PAL_BATTLE_OB_GRAY/YELLOW/...
	...
	const PAL_BTLCUSTOM_GRAVITY              ; 25
	const PAL_BTLCUSTOM_GLOW_GREEN           ; 26
	const PAL_BTLCUSTOM_PAYBACK              ; 27
	const PAL_BTLCUSTOM_GASTRO_ACID          ; 28
	const PAL_BTLCUSTOM_DARK_PULSE           ; 29
	const PAL_BTLCUSTOM_GLOW_LIME            ; 2a
	const PAL_BTLCUSTOM_DRAGON_PULSE         ; 2b
	const PAL_BTLCUSTOM_SNOW                 ; 2c
	const PAL_BTLCUSTOM_LAVA_PLUME           ; 2d
	const PAL_BTLCUSTOM_INVERT_BLACK         ; 2e
	const PAL_BTLCUSTOM_LIME                 ; 30
	const PAL_BTLCUSTOM_BEE                  ; 31
	const PAL_BTLCUSTOM_ROAR_OF_TIME         ; 32
	const PAL_BTLCUSTOM_MOON                 ; 33
	const PAL_BTLCUSTOM_DARK_VOID            ; 34
	const PAL_BTLCUSTOM_MASTER_BALL          ; 35
	const PAL_BTLCUSTOM_MASTER_BALL_CAUGHT   ; 36
	const PAL_BTLCUSTOM_ULTRA_BALL           ; 37
	const PAL_BTLCUSTOM_ULTRA_BALL_CAUGHT    ; 38
	const PAL_BTLCUSTOM_GREAT_BALL           ; 39
	const PAL_BTLCUSTOM_GREAT_BALL_CAUGHT    ; 3a
	const PAL_BTLCUSTOM_POKE_BALL            ; 3b
	const PAL_BTLCUSTOM_POKE_BALL_CAUGHT     ; 3c
	const PAL_BTLCUSTOM_SAFARI_BALL          ; 3d
	const PAL_BTLCUSTOM_SAFARI_BALL_CAUGHT   ; 3e
	const PAL_BTLCUSTOM_NET_BALL             ; 3f
	const PAL_BTLCUSTOM_NET_BALL_CAUGHT      ; 40
	const PAL_BTLCUSTOM_DIVE_BALL            ; 41
	const PAL_BTLCUSTOM_DIVE_BALL_CAUGHT     ; 42
	const PAL_BTLCUSTOM_NEST_BALL            ; 43
	const PAL_BTLCUSTOM_NEST_BALL_CAUGHT     ; 44
	const PAL_BTLCUSTOM_REPEAT_BALL          ; 45
	const PAL_BTLCUSTOM_REPEAT_BALL_CAUGHT   ; 46
	const PAL_BTLCUSTOM_TIMER_BALL           ; 47
	const PAL_BTLCUSTOM_TIMER_BALL_CAUGHT    ; 48
	const PAL_BTLCUSTOM_LUXURY_BALL          ; 49
	const PAL_BTLCUSTOM_LUXURY_BALL_CAUGHT   ; 4a
	const PAL_BTLCUSTOM_PREMIER_BALL         ; 4b
	const PAL_BTLCUSTOM_PREMIER_BALL_CAUGHT  ; 4c
	const PAL_BTLCUSTOM_DUSK_BALL            ; 4d
	const PAL_BTLCUSTOM_DUSK_BALL_CAUGHT     ; 4e
	const PAL_BTLCUSTOM_HEAL_BALL            ; 4f
	const PAL_BTLCUSTOM_HEAL_BALL_CAUGHT     ; 50
	const PAL_BTLCUSTOM_QUICK_BALL           ; 51
	const PAL_BTLCUSTOM_QUICK_BALL_CAUGHT    ; 52
	const PAL_BTLCUSTOM_CHERISH_BALL         ; 53
	const PAL_BTLCUSTOM_CHERISH_BALL_CAUGHT  ; 54
	const PAL_BTLCUSTOM_FAST_BALL            ; 55
	const PAL_BTLCUSTOM_FAST_BALL_CAUGHT     ; 56
	const PAL_BTLCUSTOM_LEVEL_BALL           ; 57
	const PAL_BTLCUSTOM_LEVEL_BALL_CAUGHT    ; 58
	const PAL_BTLCUSTOM_LURE_BALL            ; 59
	const PAL_BTLCUSTOM_LURE_BALL_CAUGHT     ; 5a
	const PAL_BTLCUSTOM_HEAVY_BALL           ; 5b
	const PAL_BTLCUSTOM_HEAVY_BALL_CAUGHT    ; 5c
	const PAL_BTLCUSTOM_LOVE_BALL            ; 5d
	const PAL_BTLCUSTOM_LOVE_BALL_CAUGHT     ; 5e
	const PAL_BTLCUSTOM_FRIEND_BALL          ; 5f
	const PAL_BTLCUSTOM_FRIEND_BALL_CAUGHT   ; 60
	const PAL_BTLCUSTOM_MOON_BALL            ; 61
	const PAL_BTLCUSTOM_MOON_BALL_CAUGHT     ; 62
	const PAL_BTLCUSTOM_PARK_BALL            ; 63
	const PAL_BTLCUSTOM_PARK_BALL_CAUGHT     ; 64
