...
; the first 6 matches PAL_BATTLE_OB_GRAY/YELLOW/...
	...
	const PAL_BTLCUSTOM_FAST_BALL          ; 38
	const PAL_BTLCUSTOM_FAST_BALL_CAUGHT   ; 39
	const PAL_BTLCUSTOM_LEVEL_BALL         ; 3a
	const PAL_BTLCUSTOM_LEVEL_BALL_CAUGHT  ; 3b
	const PAL_BTLCUSTOM_LURE_BALL          ; 3c
	const PAL_BTLCUSTOM_LURE_BALL_CAUGHT   ; 3d
	const PAL_BTLCUSTOM_HEAVY_BALL         ; 3e
	const PAL_BTLCUSTOM_HEAVY_BALL_CAUGHT  ; 3f
	const PAL_BTLCUSTOM_LOVE_BALL          ; 40
	const PAL_BTLCUSTOM_LOVE_BALL_CAUGHT   ; 41
	const PAL_BTLCUSTOM_FRIEND_BALL        ; 42
	const PAL_BTLCUSTOM_FRIEND_BALL_CAUGHT ; 43
	const PAL_BTLCUSTOM_MOON_BALL          ; 44
	const PAL_BTLCUSTOM_MOON_BALL_CAUGHT   ; 45
	const PAL_BTLCUSTOM_PARK_BALL          ; 46
	const PAL_BTLCUSTOM_PARK_BALL_CAUGHT   ; 47
