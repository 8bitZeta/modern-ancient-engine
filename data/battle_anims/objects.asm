...
; ANIM_OBJ_HAND_REVERSE
	battleanimobj RELATIVE_X, $ff, BATTLEANIMFRAMESET_BB, BATTLEANIMFUNC_NULL, PAL_BATTLE_OB_GRAY, ANIM_GFX_HIT 
; ANIM_OBJ_TEETER_DANCE
	battleanimobj RELATIVE_X, $80, BATTLEANIMFRAMESET_BC, BATTLEANIMFUNC_FLOAT_UP, PAL_BATTLE_OB_GRAY, ANIM_GFX_NOISE 
; ANIM_OBJ_ICE_BALL
	battleanimobj RELATIVE_X, $90, BATTLEANIMFRAMESET_BD, BATTLEANIMFUNC_THROW_TO_TARGET_DISAPPEAR, PAL_BATTLE_OB_BLUE, ANIM_GFX_ICE 
; ANIM_OBJ_LONG_PUNCH
	battleanimobj RELATIVE_X, $90, BATTLEANIMFRAMESET_BE, BATTLEANIMFUNC_SHAKE, PAL_BATTLE_OB_GRAY, ANIM_GFX_HIT 
; ANIM_OBJ_STAR_BURST
	battleanimobj RELATIVE_X, $ff, BATTLEANIMFRAMESET_19, BATTLEANIMFUNC_ROCK_SMASH, PAL_BATTLE_OB_YELLOW, ANIM_GFX_STARS 
; ANIM_OBJ_AIR_CUTTER
	battleanimobj RELATIVE_X | X_FLIP, $98, BATTLEANIMFRAMESET_4A, BATTLEANIMFUNC_50, PAL_BATTLE_OB_GRAY, ANIM_GFX_WHIP 
; ANIM_OBJ_OVERHEAT
	battleanimobj RELATIVE_X | X_FLIP, $98, BATTLEANIMFRAMESET_0E, BATTLEANIMFUNC_51, PAL_BATTLE_OB_RED, ANIM_GFX_FIRE 
; ANIM_OBJ_ROCK_TOMB
	battleanimobj RELATIVE_X, $ff, BATTLEANIMFRAMESET_19, BATTLEANIMFUNC_52, PAL_BATTLE_OB_BROWN, ANIM_GFX_ROCKS 
...
; ANIM_OBJ_METEOR
	battleanimobj RELATIVE_X | X_FLIP, $ff, BATTLEANIMFRAMESET_BF, BATTLEANIMFUNC_RAIN_SANDSTORM, PAL_BATTLE_OB_BLUE, ANIM_GFX_METEOR 
; ANIM_OBJ_17 ; ANIM_OBJ_FALLING_BALL
...
; ANIM_OBJ_STICK
	battleanimobj RELATIVE_X | X_FLIP, $a8, BATTLEANIMFRAMESET_8E, BATTLEANIMFUNC_ROCK_SMASH, PAL_BATTLE_OB_BROWN, $1f  
