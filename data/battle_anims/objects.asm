...
; ANIM_OBJ_BELLY_DRUM_NOTESORB_CENTER
...
; ANIM_OBJ_SHOOTING_SPARKLEROBLAST
...
;ANIM_OBJ_WILL_O_WISP_IMPACT
	battleanimobj RELATIVE_X, $a8, BATTLEANIMFRAMESET_0F, BATTLEANIMFUNC_SACRED_FIRE, PAL_BATTLE_OB_BLUE, ANIM_GFX_FIRE 
; ANIM_OBJ_CHARGE
	battleanimobj RELATIVE_X, $88, BATTLEANIMFRAMESET_4C, BATTLEANIMFUNC_RECOVER, PAL_BATTLE_OB_YELLOW, $12 
; ANIM_OBJ_TAUNT
	battleanimobj RELATIVE_X | X_FLIP, $90, BATTLEANIMFRAMESET_B9, BATTLEANIMFUNC_NULL, PAL_BATTLE_OB_GRAY, ANIM_GFX_TAUNT 
; ANIM_OBJ_ASSIST
	battleanimobj RELATIVE_X, $88, BATTLEANIMFRAMESET_BA, BATTLEANIMFUNC_HIDDEN_POWER, PAL_BATTLE_OB_GRAY, ANIM_GFX_HIT 
; ANIM_OBJ_SWEAT
	battleanimobj RELATIVE_X | X_FLIP, $a8, BATTLEANIMFRAMESET_67, BATTLEANIMFUNC_DIG, PAL_BATTLE_OB_BLUE, ANIM_GFX_SAND 
; ANIM_OBJ_HAND_REVERSE
	battleanimobj RELATIVE_X, $ff, BATTLEANIMFRAMESET_B2, BATTLEANIMFUNC_NULL, PAL_BATTLE_OB_GRAY, ANIM_GFX_HIT 
; ANIM_OBJ_TEETER_DANCE
	battleanimobj RELATIVE_X, $80, BATTLEANIMFRAMESET_B3, BATTLEANIMFUNC_FLOAT_UP, PAL_BATTLE_OB_GRAY, ANIM_GFX_NOISE 
; ANIM_OBJ_ICE_BALL
	battleanimobj RELATIVE_X, $90, BATTLEANIMFRAMESET_B5, BATTLEANIMFUNC_THROW_TO_TARGET_DISAPPEAR, PAL_BATTLE_OB_BLUE, ANIM_GFX_ICE 
; ANIM_OBJ_LONG_PUNCH
	battleanimobj RELATIVE_X, $90, BATTLEANIMFRAMESET_B5, BATTLEANIMFUNC_SHAKE, PAL_BATTLE_OB_GRAY, ANIM_GFX_HIT 
; ANIM_OBJ_STAR_BURST
	battleanimobj RELATIVE_X, $ff, BATTLEANIMFRAMESET_19, BATTLEANIMFUNC_ROCK_SMASH, PAL_BATTLE_OB_YELLOW, ANIM_GFX_STARS 
; ANIM_OBJ_AIR_CUTTER
	battleanimobj RELATIVE_X | X_FLIP, $98, BATTLEANIMFRAMESET_4A, BATTLEANIMFUNC_AIR_CUTTER, PAL_BATTLE_OB_GRAY, ANIM_GFX_WHIP 
; ANIM_OBJ_OVERHEAT
	battleanimobj RELATIVE_X | X_FLIP, $98, BATTLEANIMFRAMESET_0E, BATTLEANIMFUNC_OVERHEAT, PAL_BATTLE_OB_RED, ANIM_GFX_FIRE 
; ANIM_OBJ_ROCK_TOMB
	battleanimobj RELATIVE_X, $ff, BATTLEANIMFRAMESET_19, BATTLEANIMFUNC_ROCK_TOMB, PAL_BATTLE_OB_BROWN, ANIM_GFX_ROCKS 
; ANIM_OBJ_MUDDY_WATER
	battleanimobj ABSOLUTE_X, $00, BATTLEANIMFRAMESET_23, BATTLEANIMFUNC_SURF, PAL_BATTLE_OB_BROWN, ANIM_GFX_BUBBLE 
; ANIM_OBJ_METEOR
	battleanimobj RELATIVE_X | X_FLIP, $ff, BATTLEANIMFRAMESET_B6, BATTLEANIMFUNC_RAIN_SANDSTORM, PAL_BATTLE_OB_BLUE, ANIM_GFX_METEOR 
; ANIM_OBJ_FALLING_BALL
	battleanimobj RELATIVE_X, $90, BATTLEANIMFRAMESET_18, BATTLEANIMFUNC_DROP, PAL_BATTLE_OB_BLUE, $08 
; ANIM_OBJ_SEED
	battleanimobj RELATIVE_X, $90, BATTLEANIMFRAMESET_56, BATTLEANIMFUNC_NEEDLE, PAL_BATTLE_OB_GREEN, $1d 
; ANIM_OBJ_ROCK_BLAST
	battleanimobj RELATIVE_X | X_FLIP, $b8, BATTLEANIMFRAMESET_19, BATTLEANIMFUNC_USER_TO_TARGET_DISAPPEAR, PAL_BATTLE_OB_BROWN, $15 
; ANIM_OBJ_VOLT_TACKLE
	battleanimobj RELATIVE_X, $88, BATTLEANIMFRAMESET_43, BATTLEANIMFUNC_USER_TO_TARGET_DISAPPEAR, PAL_BATTLE_OB_YELLOW, $12 
; ANIM_OBJ_ECHOED_VOICE
	battleanimobj RELATIVE_X | X_FLIP, $90, BATTLEANIMFRAMESET_B9, BATTLEANIMFUNC_USER_TO_TARGET_DISAPPEAR, PAL_BATTLE_OB_GRAY, ANIM_GFX_PSYCHIC 
; ANIM_OBJ_UPROAR
	battleanimobj RELATIVE_X, $90, BATTLEANIMFRAMESET_BA, BATTLEANIMFUNC_RADIAL_MOVE_OUT_SLOW, PAL_BATTLE_OB_RED, ANIM_GFX_NOISE
; ANIM_OBJ_ENERGY_ORB
	battleanimobj RELATIVE_X | X_FLIP, $90, BATTLEANIMFRAMESET_BB, BATTLEANIMFUNC_RADIAL_MOVE_IN, PAL_BATTLE_OB_RED, ANIM_GFX_CHARGE
; ANIM_OBJ_ENERGY_ORB_OUT
	battleanimobj RELATIVE_X | X_FLIP, $90, BATTLEANIMFRAMESET_BB, BATTLEANIMFUNC_RADIAL_MOVE_OUT, PAL_BATTLE_OB_RED, ANIM_GFX_CHARGE
; ANIM_OBJ_ENERGY_ORB_OUT_YFIX
	battleanimobj RELATIVE_X | X_FLIP, $10, BATTLEANIMFRAMESET_BB, BATTLEANIMFUNC_RADIAL_MOVE_OUT, PAL_BATTLE_OB_RED, ANIM_GFX_CHARGE
; ANIM_OBJ_HEAT_WAVE
	battleanimobj RELATIVE_X | X_FLIP, $20, BATTLEANIMFRAMESET_10, BATTLEANIMFUNC_RAIN_SANDSTORM, PAL_BATTLE_OB_RED, ANIM_GFX_FIRE
; ANIM_OBJ_HAIL
	battleanimobj RELATIVE_X | X_FLIP, $20, BATTLEANIMFRAMESET_10, BATTLEANIMFUNC_RAIN_SANDSTORM, PAL_BATTLE_OB_BLUE, ANIM_GFX_ICE
; ANIM_OBJ_TORMENT
	battleanimobj RELATIVE_X, $80, BATTLEANIMFRAMESET_BC, BATTLEANIMFUNC_NULL, PAL_BATTLE_OB_GRAY, ANIM_GFX_STATUS
; ANIM_OBJ_FLATTER_1
	battleanimobj RELATIVE_X | X_FLIP, $80, BATTLEANIMFRAMESET_16, BATTLEANIMFUNC_RAZOR_LEAF, PAL_BATTLE_OB_YELLOW, ANIM_GFX_FLATTER
; ANIM_OBJ_FLATTER_2
	battleanimobj RELATIVE_X | X_FLIP, $80, BATTLEANIMFRAMESET_16, BATTLEANIMFUNC_RAZOR_LEAF, PAL_BATTLE_OB_BLUE, ANIM_GFX_FLATTER
